...
NAO_IP = "192.168.1.87" # Pepper default
...
import module_speechrecognition
...
class BaseSpeechReceiverModule(naoqi.ALModule):
    ...
    def __init__( self, strModuleName, strNaoIp ):
        try:
            super(BaseSpeechReceiverModule, self).__init__("BaseSpeechReceiverModule")
    ...
    def start( self ):
        ...
        self.tts = ALProxy("ALTextToSpeech", self.strNaoIp, NAO_PORT)

        memory.subscribeToEvent("ALTextToSpeech/Status",
                                "BaseSpeechReceiverModule",  # module instance
...
def main():
    ...
    BaseSpeechReceiverModule.tts.say("Hello!")
