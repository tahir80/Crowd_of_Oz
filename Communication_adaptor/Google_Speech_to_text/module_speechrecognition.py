...
logging.basicConfig(filename='time_info.log', level=logging.INFO,
...
NAO_IP = "IP_OF_PEPPER_ROBOT" # default, for running on Pepper
NAO_PORT = 9559
...
class SpeechRecognitionModule(naoqi.ALModule):
    ...
    def __init__( self, strModuleName, strNaoIp ):
        try:
            ...
            self.memory.subscribeToEvent("ALTextToSpeech/Status",
    ...
    def on_tts_status(self, key, value, message):
       ...
       time.sleep(2)
       self.start()
       print "TTS Status value:", value, key, message
    ...
    def pause(self):
        ...
        logging.info("Robot Started Talking at {}".format(datetime.datetime.utcnow()))
    ...
    def processRemote( self, nbOfChannels, nbrOfSamplesByChannel, aTimeStamp, buffer ):
        #print("INF: Module: Processing '%s' channels" % nbOfChannels)
            ...
            if(not self.isCalibrating):
                if(self.isRecording):
                    ...
                    if (timestamp - self.lastTimeRMSPeak >= self.idleReleaseTime) and (
                        ...
                        t = datetime.datetime.utcnow() - datetime.timedelta(seconds=2)
                        logging.info("User Stopped Talking at {}".format(t))
                        self.stopRecordingAndRecognize()
                else:
    ...
    def stopRecordingAndRecognize(self):
        ...
        msg = {}
        msg['message'] = ''
        msg['stop_speaking'] = 'stop_speaking'
        self.o.send('__test123__', msg)
...
def main():
    ...
    # SpeechRecognition.tts.say("Hello!")
